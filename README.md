...
Welcome to my dotfiles repo. This is a collection of vim, tmux, and zsh and bash configurations. It is based largely on [Nick Nisi's dotfiles](https://github.com/nicknisi/dotfiles) repo. Check that out for a more comprehensive setup. A lot of this README is copied directly from Nick's README. 

## Contents

+ [Initial Setup and Installation](#initial-setup-and-installation)
+ [ZSH Setup](#zsh-setup)
+ [Vim and Neovim Setup](#vim-setup)
+ [Fonts](#fonts)
...
```bash
git clone https://github.com/peterlong/dotfiles.git ~/.dotfiles
cd ~/.dotfiles
./install.sh
```
...
Nick uses Neovim and Neovim uses the [XDG base directory specification](http://standards.freedesktop.org/basedir-spec/basedir-spec-latest.html) which means it won't look for a `.vimrc` in your home directory. Instead, its configuration looks like the following:
...
Vim is likely already installed on your system. If using a Mac, MacVim will be installed from Homebrew.
